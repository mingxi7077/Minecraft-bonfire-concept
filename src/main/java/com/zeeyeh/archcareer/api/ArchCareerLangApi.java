...
import com.zeeyeh.archcareer.manager.LanguageManager;

import java.util.List;

public class ArchCareerLangApi {
    ...
    public static String translate(String path) {
        ...
        for (String result : results) {
            ...
            translate = translate.replaceAll(result, ArchCareerLangApi.translate(inPath));
        }
        return translate;
    }
}
