...
public class LanguageManager {
    ...
    public LanguageManager() {
        try {
            ...
            languageFolder = new File(ArchCareerArea.getInstance().getDataFolder(), "locales");
            if (!languageFolder.exists()) {
                ClassLoader classLoader = ArchCareerArea.class.getClassLoader();
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (name.startsWith("locales/") && !jarEntry.isDirectory()) {
                        IoUtil.copy(classLoader.getResourceAsStream(name), Files.newOutputStream(new File(ArchCareerArea.getInstance().getDataFolder(), name).toPath()));
                    }
                }
            }
        } catch (Exception e) {
            ...
            Bukkit.getPluginManager().disablePlugin(ArchCareerArea.getInstance());
        }
        initLangs();
    }
    ...
    public void initLangs() {
        ...
        langName = ArchCareerArea.getInstance().getConfig().getString("locale");
    }
    ...
    public Object translate(String path) {
        if (langName == null) {
            Bukkit.getConsoleSender().sendMessage("[ZeeyehX] Plugin language configuration error, please go to the " +
                    new File(ArchCareerArea.getInstance().getDataFolder(), "config.yml").getAbsolutePath() +
    ...
    //    localesFolder = new File(ArchCareerArea.getInstance().getDataFolder(), "locales");
    ...
    //    clear();
    //    loadConfigs();
    //    String localName = ArchCareerArea.getInstance().getConfig().getString("locale");
    ...
    //        }
    //    }
    //    InputStream inputStream = ArchCareerArea.getInstance().getResource("locales/zh_cn.json");
    //    try {
