package com.zeeyeh.infinitemining.api;

import cn.hutool.core.util.ReUtil;
import com.zeeyeh.infinitemining.LanguageManager;

import java.util.List;

public class InfiniteMiningLangApi {
    ...
    public static String translate(String path) {
        ...
        for (String result : results) {
            ...
            translate = translate.replaceAll(result, InfiniteMiningLangApi.translate(inPath));
        }
        return translate;
    }
}
